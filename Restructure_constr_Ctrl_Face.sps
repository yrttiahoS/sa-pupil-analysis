...
EXECUTE.  
*save selected.
SAVE OUTFILE='CtrlFace_constriction_accept.sav' 
  /COMPRESSED. 
...
*aggregate long form data.
DATASET DECLARE Constr_aggr_CtrlFace. 
AGGREGATE 
  /OUTFILE='Constr_aggr_CtrlFace' 
  /BREAK=IDsubj Arousal Valence 
  /Constr_mean=MEAN(pupilValue) 
  /N_trials=N. 
DATASET ACTIVATE Constr_aggr_CtrlFace. 
 
SAVE OUTFILE='CtrlFace_constriction_aggr.sav'
   /COMPRESSED.
