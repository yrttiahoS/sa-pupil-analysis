...
EXECUTE.  
*save selected.
SAVE OUTFILE='Eprime_constriction_accept.sav' 
  /COMPRESSED. 
...
*aggregate long form data.
DATASET DECLARE Constr_aggr_Eprime. 
AGGREGATE 
  /OUTFILE='Constr_aggr_Eprime' 
  /BREAK=IDsubj Arousal Valence 
  /Constr_mean=MEAN(pupilValue) 
  /N_trials=N. 
DATASET ACTIVATE Constr_aggr_Eprime. 
 
SAVE OUTFILE='Eprime_constriction_aggr.sav'
   /COMPRESSED.
