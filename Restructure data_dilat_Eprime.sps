...
EXECUTE.  
*save selected.
SAVE OUTFILE='Eprime_dilation_accept.sav' 
  /COMPRESSED. 
...
DATASET DECLARE Dilat_aggr_Eprime. 
AGGREGATE 
  /OUTFILE='Dilat_aggr_Eprime' 
  /BREAK=IDsubj Arousal Valence 
  /Dilat_mean=MEAN(combination2) 
  /N_trials=N. 
DATASET ACTIVATE Dilat_aggr_Eprime. 
 
SAVE OUTFILE='Eprime_dilation_aggr.sav'
   /COMPRESSED.
...
SAVE OUTFILE='Eprime_dilat_repeated.sav'
   /COMPRESSED.
