...
EXECUTE.  
*save selected.
SAVE OUTFILE='CtrlNoise_dilation_accept.sav' 
  /COMPRESSED. 
...
DATASET DECLARE Dilat_aggr_CtrlNoise. 
AGGREGATE 
  /OUTFILE='Dilat_aggr_CtrlNoise' 
  /BREAK=IDsubj Arousal Valence 
  /Dilat_mean=MEAN(combination2) 
  /N_trials=N. 
DATASET ACTIVATE Dilat_aggr_CtrlNoise. 
 
SAVE OUTFILE='CtrlNoise_dilation_aggr.sav'
   /COMPRESSED.
