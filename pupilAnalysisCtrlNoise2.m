function pupilAnalysisCtrlNoise2
...
min_pup_time = 4000;%2800;%% 300;%
%end of time window for mean pupil diameter, ms; DONT USE VALUES > %5000!!!!!, %1200;1000; %5000;
max_pup_time = 5000;%3800;%1000; % ;1200; %1000 MUST BE MAX 1000 for 'FaceBorder' flash
...
if max_pup_time > 4000
    outputfilename = 'CtrlDilationNoise2';
else
    outputfilename = 'CtrlConstrictionNoise2';
end
